...
class FileGeneratorController:
    ...
    def get_path_template(self):
        ...
        self.create_files_items(self.view.components['{}.general_panel'.format(self.name)])
    ...
    def create_panel_routes_configuration(self,text,func,index):
    ...
    def generate_files(self):
        self.class_definition.from_json(self.view.components['{}.leftPanel'.format(self.name)].get_class_representation())
